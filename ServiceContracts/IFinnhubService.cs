...
/// <summary>
/// Represents a service that makes HTTP request to finnhub.io
/// </summary>
public interface IFinnhubService
{
    /// <summary>
    /// Returns company details such as company country, currency, exchange, IPO date,
    /// logo image, market capitalization, name of the company, phone number etc
    /// </summary>
    ...
    /// high price of the day, low price of the day, open price of the day, previous close price
    /// </summary>
    /// <param name="stockSymbol">Stock symbol to search</param>
