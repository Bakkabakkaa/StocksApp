...
namespace Stocks.Controllers.Tests;
...
public class StocksControllerTest
{
    ...
    public async Task Explore_StockIsNull_ShouldReturnExploreViewWithStocksList()
    {
        ...
        List<Dictionary<string, string>>? stocksDict =
            Newtonsoft.Json.JsonConvert.DeserializeObject<List<Dictionary<string, string>>>(
                @"[{""currency"":""USD"",""description"":""APPLE INC"",""displaySymbol"":""AAPL"",""figi"":""BBG000B9XRY4"",""isin"":null,""mic"":""XNAS"",""shareClassFIGI"":""BBG001S5N8V8"",""symbol"":""AAPL"",""symbol2"":"""",""type"":""Common Stock""}, {""currency"":""USD"",""description"":""MICROSOFT CORP"",""displaySymbol"":""MSFT"",""figi"":""BBG000BPH459"",""isin"":null,""mic"":""XNAS"",""shareClassFIGI"":""BBG001S5TD05"",""symbol"":""MSFT"",""symbol2"":"""",""type"":""Common Stock""}, {""currency"":""USD"",""description"":""AMAZON.COM INC"",""displaySymbol"":""AMZN"",""figi"":""BBG000BVPV84"",""isin"":null,""mic"":""XNAS"",""shareClassFIGI"":""BBG001S5PQL7"",""symbol"":""AMZN"",""symbol2"":"""",""type"":""Common Stock""}, {""currency"":""USD"",""description"":""TESLA INC"",""displaySymbol"":""TSLA"",""figi"":""BBG000N9MNX3"",""isin"":null,""mic"":""XNAS"",""shareClassFIGI"":""BBG001SQKGD7"",""symbol"":""TSLA"",""symbol2"":"""",""type"":""Common Stock""}, {""currency"":""USD"",""description"":""ALPHABET INC-CL A"",""displaySymbol"":""GOOGL"",""figi"":""BBG009S39JX6"",""isin"":null,""mic"":""XNAS"",""shareClassFIGI"":""BBG009S39JY5"",""symbol"":""GOOGL"",""symbol2"":"""",""type"":""Common Stock""}]");
        ...
        var expectedStocks = stocksDict!
            ...
            {
                StockName = (string)temp["description"],
                StockSymbol = (string)temp["symbol"]
            })
            .ToList();
