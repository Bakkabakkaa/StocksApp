...
/// <summary>
/// Represents a repository that makes HTTP request to finnhub.io
/// </summary>
public interface IFinnhubRepository
{
    /// <summary>
    /// Returns company details such as company country, currency, exchange,
    /// IPO date, logo image, market capitalization, name of the company, phone number etc.
    /// </summary>
    ...
    /// percentage change, high price of the day, low price of the day,
    /// open price of the day, previous close price
    /// </summary>
    /// <param name="stockSymbol">Stock symbol to search</param>
    /// <returns>Returns a dictionary that contains details such as current price,
    /// change in price, percentage change, high price of the day, low price of the
    /// day, open price of the day, previous close price</returns>
